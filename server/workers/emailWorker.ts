...
const QUEUE_NAME = 'helpdesk.notification_queue_v2';

const DLX_EXCHANGE = 'helpdesk.events.dlx';
const DLQ_QUEUE = 'helpdesk.notification_queue_v2.dlq';
const DLQ_ROUTING_KEY = 'helpdesk.notification_queue_v2.dlq.routing';
